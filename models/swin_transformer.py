...
def build_swin_transformer(modelname, img_size, num_classes=1000):
    assert modelname in ['swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k', 'swin_B_256_22k']
...
if __name__ == "__main__":
    ...
    # model = build_swin_transformer('swin_L_224_22k', 224)
    # x = torch.rand(2, 3, 224, 224)
    # y = model(x)
    # print(y.shape)

    model = build_swin_transformer('swin_B_256_22k', 256)
