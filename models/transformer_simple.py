...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, pos_embed, mask=None):
        ...
        # decoder 的第一次输入，默认为0
        # 我认为可以从这个地方下手，对transformer结构进行改进
        # tgt.shape=[Nq, B, C]
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
                     ...
                     query_pos: Optional[Tensor] = None):
        '''
        :param tgt: object queries
        :param memory: encoder输出的embedding
        :param tgt_mask:
        :param memory_mask:
        :param tgt_key_padding_mask:
        :param memory_key_padding_mask:
        :param pos: encoder output posision embedding
        :param query_pos: object queries position embedding
        :return:
        '''
