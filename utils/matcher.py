...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1, cost_bbox: float = 1, cost_giou: float = 1):
        ...
        :param cost_bbox: This is the relative weight of the L1 error of the bounding box coordinates in the matching cost
        :param cost_giou: This is the relative weight of the giou loss of the bounding box in the matching cost
        '''
        super().__init__()
    ...
    def forward(self, outputs, targets):
        ...
        # In the last dimension of C, we divide it into B costs, and each cost is [B, num_queries, M_i]
        # where sum(Mi) = M.
        # i is the batch index and c is cost_i = [B, num_queries, M_i].
